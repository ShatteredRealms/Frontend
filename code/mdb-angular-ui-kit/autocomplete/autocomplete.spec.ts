...
import { DOWN_ARROW, ESCAPE, UP_ARROW, TAB, HOME, END, ENTER } from '@angular/cdk/keycodes';
...
describe('MdbAutocomplete', () => {
  ...
  describe('Keyboard navigation', () => {
    ...
    it('should highlight last option when pressing end', fakeAsync(() => {
      input.focus();
      fixture.detectChanges();
      flush();
    ...
    it('should select highlighted option when pressing enter', fakeAsync(() => {
      ...
      expect(input.value).toEqual('Green');
    }));
