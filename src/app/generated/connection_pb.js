...
goog.exportSymbol('proto.sro.gamebackend.ConnectGameServerRequest', null, global);
 ...
 * @constructor
 */
proto.sro.gamebackend.ConnectGameServerRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sro.gamebackend.ConnectGameServerRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sro.gamebackend.ConnectGameServerRequest.displayName = 'proto.sro.gamebackend.ConnectGameServerRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.sro.gamebackend.ConnectGameServerRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.sro.gamebackend.ConnectGameServerRequest.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.sro.gamebackend.ConnectGameServerRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sro.gamebackend.ConnectGameServerRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.sro.gamebackend.ConnectGameServerRequest}
 */
proto.sro.gamebackend.ConnectGameServerRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sro.gamebackend.ConnectGameServerRequest;
  return proto.sro.gamebackend.ConnectGameServerRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.sro.gamebackend.ConnectGameServerRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sro.gamebackend.ConnectGameServerRequest}
 */
proto.sro.gamebackend.ConnectGameServerRequest.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.sro.gamebackend.ConnectGameServerRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sro.gamebackend.ConnectGameServerRequest.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.sro.gamebackend.ConnectGameServerRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sro.gamebackend.ConnectGameServerRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.sro.gamebackend.ConnectGameServerRequest.prototype.getCharacterId = function() {
...
/**
 * @param {number} value
 * @return {!proto.sro.gamebackend.ConnectGameServerRequest} returns this
 */
proto.sro.gamebackend.ConnectGameServerRequest.prototype.setCharacterId = function(value) {
